...
void Difference::OnResponce(BinaryReader& Reader)
{
	...
	int32 Len7466 = Reader.ReadInt();
	for(int32 i = 0; i < Len7466; i++)
	{
	...
	//Len concatenated with rand number to get rid of confusions with redefinition
	int32 Len24557 = Reader.ReadInt();
	for(int32 i = 0; i < Len24557; i++)
	{
	...
	//Len concatenated with rand number to get rid of confusions with redefinition
	int32 Len9537 = Reader.ReadInt();
	for(int32 i = 0; i < Len9537; i++)
	{
	...
	//Len concatenated with rand number to get rid of confusions with redefinition
	int32 Len26015 = Reader.ReadInt();
	for(int32 i = 0; i < Len26015; i++)
	{
	...
	//Len concatenated with rand number to get rid of confusions with redefinition
	int32 Len2023 = Reader.ReadInt();
	for(int32 i = 0; i < Len2023; i++)
	{
