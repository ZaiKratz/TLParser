...
public:
	Dialog();
	Dialog(bool pinned, TLBaseObject* peer, int32 top_message, int32 read_inbox_max_id, int32 read_outbox_max_id, int32 unread_count, int32 unread_mentions_count, COMMON::PeerNotifySettings* notify_settings, int32 pts, COMMON::DraftMessage* draft);
