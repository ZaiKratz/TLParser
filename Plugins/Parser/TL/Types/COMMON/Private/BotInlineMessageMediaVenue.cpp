...
{
	this->_ConstructorID = 774071875;
}

BotInlineMessageMediaVenue::BotInlineMessageMediaVenue(COMMON::GeoPoint* geo, FString title, FString address, FString provider, FString venue_id, PRIVATE::ReplyMarkup* reply_markup)
{
	this->_ConstructorID = 774071875;
	this->geo = geo;
	this->title = title;
