...
Updates::Updates()
{
	this->_ConstructorID = 1078111860;
}
...
void Updates::OnResponce(BinaryReader& Reader)
{
	...
	int32 Len20259 = Reader.ReadInt();
	for(int32 i = 0; i < Len20259; i++)
	{
	...
	//Len concatenated with rand number to get rid of confusions with redefinition
	int32 Len27688 = Reader.ReadInt();
	for(int32 i = 0; i < Len27688; i++)
	{
	...
	//Len concatenated with rand number to get rid of confusions with redefinition
	int32 Len26233 = Reader.ReadInt();
	for(int32 i = 0; i < Len26233; i++)
	{
